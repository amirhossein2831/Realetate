        ...
        <ul class="navbar-nav">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
                    ...
                    <div class="p-1">
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                <img class="wd-30 ht-30 rounded-circle" src="{{$user->profile->profile_image}}"
                                     alt="userr">
                            </div>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{$user->profile->profile_image}}" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{$user->profile->profile_image}}" alt="">
                        </div>
                    ...
                    <ul class="list-unstyled p-1">
                        ...
                        <li class="dropdown-item py-2">
                            <form action="{{route('admin.logout')}}" method="post">
                                ...
                                <button type="submit" style="background: transparent; border: 0;color: #dee2e6;">
                                    <span>Log Out</span>
                                </button>
                            </form>
                        </li>
